...
export const Layout = ({ children }) => {
    return (
        <div className=" w-screen h-screen layout">
            <nav className="w-full h-16  bg-transparent sticky top-0 left-0 flex flex-row px-12 justify-between items-center">
                <div className="h-full flex flex-row items-center gap-8 w-fit">
                ...
                <div className="flex gap-8 mid-nav">
